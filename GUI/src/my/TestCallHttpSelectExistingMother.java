		...
		try {
			...
			if (success.length() != 0) {
				...
				if (ss.equals("true")) {
					...
					JOptionPane.showMessageDialog(null, "add Mothersuccessfully！", "prompt", JOptionPane.PLAIN_MESSAGE);
				} else {
					JOptionPane.showMessageDialog(null, "add Mother Failed！！！", "prompt", JOptionPane.PLAIN_MESSAGE);
				}
			}
