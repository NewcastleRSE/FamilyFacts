...
public class TestCallHttpAddFather {
	static String ss;
	static void httpURLPOSTCase(String personid, String firstname, String lastname, String sex, String birth, String death, String address) {
		String POST_URL = "http://3.9.172.108:8090/api/person/create/father";
		try {
