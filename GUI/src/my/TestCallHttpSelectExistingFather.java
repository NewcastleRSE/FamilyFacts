...
public class TestCallHttpSelectExistingFather {
	static String ss;

	static void httpURLPOSTCase(String personid, String fatherid) {
		String POST_URL = "http://3.9.172.108:8090/api/person/update/father";
		try {
			...
			String parm = "person_id=135&father_id=137";
			...
			if (success.length() != 0) {
				...
				if (ss.equals("true")) {
					...
					JOptionPane.showMessageDialog(null, "add Father successfully！", "prompt",
							JOptionPane.PLAIN_MESSAGE);
				} else {
					JOptionPane.showMessageDialog(null, "add Father Failed！！！", "prompt", JOptionPane.PLAIN_MESSAGE);
				}
			}
