...
//Edit-Unlink-From Parent
public class EditUnlinkFromParent extends JDialog {
	...
	public EditUnlinkFromParent(JFrame owner) {
		super(owner, "Edit Unlink From Parent", true);
